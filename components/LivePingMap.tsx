  ...
  return (
    <>
      ...
      <style jsx global>{`
        ...
        .map-v3-topbar{top:7px!important;left:12px!important;right:12px!important;min-height:36px!important;padding:3px 6px!important;border:1px solid rgba(16,19,17,.08)!important;border-bottom:0!important;border-radius:14px 14px 0 0!important;background:rgba(255,255,255,.95)!important;box-shadow:0 6px 18px rgba(16,25,18,.06)!important;backdrop-filter:blur(18px) saturate(145%)!important;-webkit-backdrop-filter:blur(18px) saturate(145%)!important;justify-content:flex-end!important}
        .map-v3-brand{position:absolute!important;left:50%!important;top:50%!important;transform:translate(-50%,-50%)!important;display:flex!important;align-items:baseline!important;gap:5px!important;padding:0!important;border:0!important;background:transparent!important;box-shadow:none!important;white-space:nowrap!important}.map-v3-brand .brand{font-size:0!important;line-height:1!important;text-transform:none!important}.map-v3-brand .brand span{display:none!important}.map-v3-brand .brand::before{content:"pindrizzle";font-size:14px;line-height:1;font-weight:790;letter-spacing:-.42px;text-transform:lowercase;color:var(--ping-ink)}.map-v3-brand>strong{font-size:7px!important;line-height:1!important;font-weight:740!important;color:var(--ping-muted)!important;text-transform:lowercase!important}
        .map-v3-top-actions{display:flex!important;gap:3px!important}.map-v3-top-actions button{display:grid!important;width:26px!important;height:26px!important;place-items:center!important;border:0!important;border-radius:8px!important;background:var(--ping-surface-soft)!important;box-shadow:none!important;color:var(--ping-ink-2)!important;font-size:12px!important}.map-v3-top-actions button svg{width:14px!important;height:14px!important}.map-v3-top-actions button:active{transform:scale(.95)}.map-v3-top-actions button:last-child:active{transform:rotate(18deg) scale(.95)}
        .map-v3-controls{top:42px!important;left:12px!important;right:12px!important;padding:3px 6px 5px!important;border:1px solid rgba(16,19,17,.08)!important;border-top:0!important;border-radius:0 0 14px 14px!important;background:rgba(255,255,255,.95)!important;box-shadow:0 7px 18px rgba(16,25,18,.06)!important;backdrop-filter:blur(18px) saturate(145%)!important;-webkit-backdrop-filter:blur(18px) saturate(145%)!important}.map-v3-status{display:none!important}.map-v3-control-row{margin-top:0!important;grid-template-columns:minmax(0,1fr) minmax(82px,104px)!important;gap:4px!important}.map-v3-radii{padding:1px!important;gap:1px!important;border-radius:8px!important;background:var(--ping-surface-soft)!important}.map-v3-radii button{height:21px!important;border-radius:6px!important;background:transparent!important;font-size:6.8px!important;font-weight:760!important}.map-v3-radii button.active{background:var(--ping-ink)!important;color:#fff!important;box-shadow:0 2px 6px rgba(16,19,17,.12)!important}.map-v3-filter-button{height:23px!important;max-width:none!important;justify-content:space-between!important;border:0!important;border-radius:8px!important;background:var(--ping-surface-soft)!important;padding:0 7px!important;font-size:6.8px!important}.map-v3-filter-button svg{width:12px!important;height:12px!important}
        @media(max-width:350px){.map-v3-topbar{left:8px!important;right:8px!important}.map-v3-controls{left:8px!important;right:8px!important}.map-v3-brand .brand::before{font-size:13px}.map-v3-top-actions button{width:25px!important;height:25px!important}.map-v3-control-row{grid-template-columns:minmax(0,1fr) 80px!important}.map-v3-radii button{font-size:6.4px!important}}
