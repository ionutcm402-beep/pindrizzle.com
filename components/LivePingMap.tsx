  ...
  return (
    <>
      ...
      <style jsx global>{`
        ...
        .map-v3-topbar{top:8px!important;left:12px!important;right:12px!important;min-height:42px!important;padding:4px 7px!important;border:1px solid rgba(16,19,17,.08)!important;border-bottom:0!important;border-radius:16px 16px 0 0!important;background:rgba(255,255,255,.95)!important;box-shadow:0 7px 22px rgba(16,25,18,.07)!important;backdrop-filter:blur(18px) saturate(145%)!important;-webkit-backdrop-filter:blur(18px) saturate(145%)!important;justify-content:flex-end!important}
        .map-v3-brand{position:absolute!important;left:50%!important;top:50%!important;transform:translate(-50%,-50%)!important;display:flex!important;align-items:baseline!important;gap:6px!important;padding:0!important;border:0!important;background:transparent!important;box-shadow:none!important}.map-v3-brand .brand{font-size:17px!important;letter-spacing:-.5px!important}.map-v3-brand>strong{font-size:8px!important;font-weight:760!important;color:var(--ping-muted)!important}
        .map-v3-top-actions{display:flex!important;gap:4px!important}.map-v3-top-actions button{display:grid!important;width:30px!important;height:30px!important;place-items:center!important;border:0!important;border-radius:9px!important;background:var(--ping-surface-soft)!important;box-shadow:none!important;color:var(--ping-ink-2)!important;font-size:14px!important}.map-v3-top-actions button:active{transform:scale(.95)}.map-v3-top-actions button:last-child:active{transform:rotate(18deg) scale(.95)}
        .map-v3-controls{top:49px!important;left:12px!important;right:12px!important;padding:4px 7px 6px!important;border:1px solid rgba(16,19,17,.08)!important;border-top:0!important;border-radius:0 0 16px 16px!important;background:rgba(255,255,255,.95)!important;box-shadow:0 9px 22px rgba(16,25,18,.07)!important;backdrop-filter:blur(18px) saturate(145%)!important;-webkit-backdrop-filter:blur(18px) saturate(145%)!important}.map-v3-status{display:none!important}.map-v3-control-row{margin-top:0!important;grid-template-columns:minmax(0,1fr) minmax(88px,112px)!important;gap:5px!important}.map-v3-radii{padding:2px!important;gap:1px!important;border-radius:9px!important;background:var(--ping-surface-soft)!important}.map-v3-radii button{height:24px!important;border-radius:7px!important;background:transparent!important;font-size:7.5px!important;font-weight:760!important}.map-v3-radii button.active{background:var(--ping-ink)!important;color:#fff!important;box-shadow:0 2px 7px rgba(16,19,17,.13)!important}.map-v3-filter-button{height:28px!important;max-width:none!important;justify-content:space-between!important;border:0!important;border-radius:9px!important;background:var(--ping-surface-soft)!important;padding:0 8px!important;font-size:7.5px!important}.map-v3-filter-button svg{width:14px!important;height:14px!important}
        @media(max-width:350px){.map-v3-topbar{left:8px!important;right:8px!important}.map-v3-controls{left:8px!important;right:8px!important}.map-v3-brand .brand{font-size:15px!important}.map-v3-top-actions button{width:28px!important;height:28px!important}.map-v3-control-row{grid-template-columns:minmax(0,1fr) 84px!important}.map-v3-radii button{font-size:7px!important}}
