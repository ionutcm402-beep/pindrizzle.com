...
export default function FirstRunOnboarding() {
  ...
  return <div className="first-run-backdrop" role="dialog" aria-modal="true" aria-labelledby="ping-onboarding-title"><section className="first-run-sheet" ref={sheetRef}>
    ...
    {step === 1 ? <div className="first-run-step first-run-step-one pd-moment">
      <div className="first-run-intro"><div className="first-run-kicker"><i aria-hidden="true" />LOCAL BY DESIGN</div><h1 id="ping-onboarding-title" className="first-run-heading" ref={headingRef} tabIndex={-1}>See what matters nearby.</h1><p className="first-run-copy">Local pins from people nearby, ranked for usefulness.</p></div>
      <div className="first-run-content-grid"><div className="first-run-benefits">
        <div className="first-run-benefit"><span className="first-run-icon"><PingIcon name="location" size={20} /></span><div><strong>Nearby first</strong><small>Your selected radius controls what appears.</small></div></div>
        <div className="first-run-benefit"><span className="first-run-icon"><PingIcon name="outages" size={20} /></span><div><strong>Current and useful</strong><small>Alerts, traffic, lost & found, deals, Marketplace and local updates.</small></div></div>
        <div className="first-run-benefit"><span className="first-run-icon"><PingIcon name="shield" size={20} /></span><div><strong>Community checked</strong><small>People nearby can confirm useful information or report problems.</small></div></div>
        <div className="first-run-browse-note"><span className="first-run-note-icon"><PingIcon name="feed" size={19} /></span><span>Browse without an account. Sign in when you want to participate.</span></div>
      ...
      <div className="first-run-actions"><button type="button" className="first-run-primary" onClick={() => setStep(2)}>Choose area <span aria-hidden="true">→</span></button></div>
    </div> : <div className="first-run-step first-run-step-two pd-moment">
      <div className="first-run-intro compact"><div className="first-run-kicker"><i aria-hidden="true" />YOUR AREA</div><h1 id="ping-onboarding-title" className="first-run-heading" ref={headingRef} tabIndex={-1}>Choose your nearby radius.</h1><p className="first-run-copy">You can change this later from Feed or You.</p></div>
      ...
      <div className="first-run-privacy"><span className="first-run-icon"><PingIcon name="shield" size={20} /></span><div><strong>Approximate location by default.</strong><small>New pins show an approximate area unless you deliberately choose Exact.</small></div></div>
      <div className="first-run-actions two"><button type="button" className="first-run-primary" onClick={() => finish(true)}>Open Feed <span aria-hidden="true">→</span></button><button type="button" className="first-run-secondary" onClick={() => setStep(1)}>Back</button></div>
    </div>}
