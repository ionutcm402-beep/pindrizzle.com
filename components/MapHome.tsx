...
import MapComposeController from "@/components/MapComposeController";
...
export default function MapHome(){
  ...
  useEffect(()=>{setSelectedId((current)=>current&&pings.some((ping)=>ping.id===current)?current:null);},[pings]);
  ...
  <MapComposeController coordinates={center} locationState={locationState} onRequestLocation={requestLocation} onPublished={()=>setRefreshKey((value)=>value+1)}/>
